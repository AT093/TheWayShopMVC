...
namespace TheWayShop.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(TheWayShopContext context)
        {
            _context = context;
        }
        ...
        {
            HttpContext.Session.Clear();
            // Password and admin login 
            if ((Login.LoginUser.Equals("TheWayShop@admin.com") && Login.Password.Equals("TheWayShop@admin.com") ))
            {
        ...
        public async Task<IActionResult> UserLogin([Bind("Id,LoginUser,Password")] Login Login)
        {
            ...
            if ((Login.LoginUser.Equals("TheWayShop@admin.com") && Login.Password.Equals("TheWayShop@admin.com") )|| LoginData != null)
            {
                if (LoginData != null)
                {
